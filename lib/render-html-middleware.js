...
module.exports = function (handler) {
  var templates = [
    { // this is also the default template
      id: 'BAR',
      regex: new RegExp('http[s]?\://data\.alod\.ch/'),
